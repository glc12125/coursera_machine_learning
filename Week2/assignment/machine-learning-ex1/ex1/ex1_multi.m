...
theta1 = zeros(3, 1);
[theta1, J_history1] = gradientDescentMulti(X, y, theta1, 0.01, num_iters);
theta2 = zeros(3, 1);
...
theta4 = zeros(3, 1);
[theta4, J_history4] = gradientDescentMulti(X, y, theta4, 0.3, num_iters);
...
price = [1, (1650-mu(1))/sigma(1), (3 - mu(2))/sigma(2)] * theta3;
